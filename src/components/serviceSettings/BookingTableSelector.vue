<template>
  <div style="height: inherit; overflow: hidden">
    <div
      class="row px-10 pt-10 full-width gap-5 no-wrap pb-10"
    ...
    >
      <div
        ...
        :key="index"
        class="box-shadow cursor-pointer px-6 py-3 border-radius secondary-text"
        :class="
    ...
    <div
      ...
      class="row items-center pb-8 full-width no-wrap gap-5 px-10 pt-5"
      style="overflow-x: auto"
    >
      ...
      <div
        ...
        :key="index_"
        style="white-space: nowrap"
        class="px-4 py-2 bg-background-color border-radius row no-wrap items-center gap-3 box-shadow body"
      >
        Стол
        {{ table.number }}
        <CIcon
    ...
    <div class="px-10">
      <div
        class="full-width"
        :style="
          selectedTables.length ? 'max-height: 385px;' : 'max-height: 430px;'
        "
        style="overflow: auto"
      >
